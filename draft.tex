...
abstraction and the IMPACT algorithm. We have implemented both methods
and report the results of an experimental comparison.
\end{abstract}
...
consider the constants $\top,\bot$ of sort $\Bool$.
