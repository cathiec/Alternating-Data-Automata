...
\begin{lemma}\label{lemma:abstract-invariant}
  ...
  an invariant for $\A$. 
\end{lemma}
\proof{ It is sufficient to show that there exists $k>0$ such that for
  all $u \in \Sigma^*$ there exists $i \in [1,k]$ such that
  ...
  there exists $k > 0$ such that, for all $u \in \Sigma^*$ there
  exists $i \in [1,k]$ such that $\abs{\Post{\A}}(\iota,u) \eqiff
