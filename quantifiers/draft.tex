...
first-order formula $I$ such that: \begin{compactitem}
\item the formula $\phi \rightarrow I$ is valid,
\item the formula $I \wedge \psi$ is unsatisfiable, 
...
to produce Lyndon interpolants. For instance, interpolating decision
procedures exist for linear real and integer arithmetic, with
