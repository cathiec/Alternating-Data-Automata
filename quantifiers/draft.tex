...
use such non-local interpolants for the coverage between the nodes of
the unfolding of an automaton (Definition \ref{def:coverage}).

\subsection{Coverage with Non-local Interpolants}
