...
the automaton. For instance, the \impact~ semi-algorithm
\cite{McMillan06} upon which our procedure is based, continuosly
expands the domain of the unfolding, while partially recomputing its
labeling and the coverage, and stops when a safe complete unfolding
has been found. The following theorem proves the soundness of this
method:
...
procedure, used to label the unfoldings. We shall discuss generation
of interpolants in the remainder of this section.
