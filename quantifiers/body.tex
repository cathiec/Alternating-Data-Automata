...
in exactly $1$ time unit. Formally, $\lang{A} = \set{a, t_1, \ldots a,
  t_n \mid t_1, \ldots, t_n \in \real,~ n > 1 \Rightarrow t_1 \geq 2}$
and $\lang{B} = \set{\sigma_1, t_1 \ldots \sigma_{i-1}, t_{i-1}, a,
  t_i, \ldots \sigma_n, t_n \mid \sigma_1, \ldots, \sigma_n \in
  \set{a,b},~ n \geq 1,~ t_1, \ldots, t_n \in \real,~ 1 < i < n
  \Rightarrow t_i-t_{i-1} \neq 1}$. It is proved\footnote{See
