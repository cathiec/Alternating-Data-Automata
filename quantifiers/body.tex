...
\begin{definition}\label{def:unfolding}
  ...
  \end{array}\]  
  $U$ is \emph{safe} if for each $\alpha \in \dom(U)$, the formula
  $U(\alpha) \wedge \bigwedge_{q \in Q \setminus F} \forall y_1 \ldots
...
\begin{theorem}[\cite{BorgerGraedelGurevich97}]\label{thm:skolem}
  ...
  holds.
\end{theorem}
\paragraph{Proof.} See \cite[Theorem 2.1.8]{BorgerGraedelGurevich97} and
