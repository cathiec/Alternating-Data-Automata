...
simplicity, we defer the details of the semi-algorithm to Appendix
\ref{app:algorithm} and content ourselves of several high-level
definitions.
...
\hline
Example & $\len{\A}$ (bytes) & Nb of Predicates & Nb of Variables & Nb of Transitions & $L(\A)=\emptyset$ ? & Nodes Expanded & Nodes Visited & Time (ms) \\
\hline
