...
several undecidable but recursively enumerable problems, for which no
effective methods exist, to date: inclusion between recognizable timed
...
For reasons of space, all proofs of results in this paper are given in
\cite{IosifXu18ArXiv}. 
